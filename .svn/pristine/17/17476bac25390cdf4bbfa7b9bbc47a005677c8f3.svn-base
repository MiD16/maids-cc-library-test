		...
		<div class="col-12 ">
			...
			<div class="card shadow">
				<div class="card-header">
					...
					<strong class="card-title"> تعديل صلاحية -   <span style="color: #d1a923">
							...
							<div class="wizard clearfix row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<label for="action_name_ar"> اسم الصلاحية باللغة
											العربية *</label> <input id="action_name_ar" name="action_name_ar"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<label for="action_name_en"> اسم الصلاحية باللغة
											الثانوية *</label> <input id="action_name_en" name="action_name_en"
								...
								<div class="actions clearfix">
									<ul role="menu" aria-label="Pagination">
										<li aria-hidden="false" aria-disabled="false"><button
												type="submit" class="btn mb-2 btn-primary">تعديل</button>
									</ul>
								</div>
