		...
		<div class="col-12 ">
			...
			<div class="panel panel-default">
												...
												<tbody>
													...
													<c:forEach varStatus="status" var="varuserList"
														...
														<tr>
															...
															<td>${varuserList.applicationDate}</td>
															<td>${varuserList.period.accPeriodValue} ${varuserList.period.dateUnitId.nameA}</td>

															<td>${varuserList.interest.descriptionA}</td>
															<td>${varuserList.currency.nameA}</td>
															<td>${varuserList.rateValue} %</td>
															...
															<td><i id="delete_${status.index}"
																...
																onclick="window.location.href='${pageContext.request.contextPath}/interestRate/delete?id=${varuserList.id} '"
																class=" fe fe-delete icon-delete"></i> &nbsp&nbsp&nbsp <i
																id="edit_${status.index}" data-id="${status.index}"
																onclick="window.location.href='${pageContext.request.contextPath}/interestRate/update?id=${varuserList.id} '"
																class=" fe fe-edit icon-edit"> </i> &nbsp&nbsp<i
																id="edit_${status.index}" data-id="${status.index}"
																onclick="window.location.href='${pageContext.request.contextPath}/interestRate/details?id=${varuserList.id} '"
				...
				<jsp:include page="/WEB-INF/jsp/layout/pagination.jsp">
					<jsp:param name="controller_url" value="/interestRate/index" />
