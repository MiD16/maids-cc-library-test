		...
		<div class="col-12 ">
				...
				<div class="card-body">
					<div class="row">
										...
										<tbody>
											<c:forEach var="systable" items="${sysTable}">
												<tr>
													...
													<c:if test="${tableId eq 'CUSTOMER_SITUATION'  || tableId eq 'CUSTOMER_STAGE'}">
													...
													<td>
														<div class="row">
															<%--WORKING FINE <a
																href="<c:url value='/HomeConfiguration/create?tableId=${tableId}&elementId=${systable.id }' />">
																<i class="fe fe-edit icon-edit"></i>

															</a> --%>
															
													<a
																href="<c:url value='/HomeConfiguration/create?elementId=${systable.id }' />">
																<i class="fe fe-edit icon-edit"></i>
																				...
																				<div class="col-10">
																					<div class="form-group mb-3">
																						...
																						<div class="form-group col-md-12" align="left">
																							<a
																								href="<c:url value='/HomeConfiguration/delete?tableId=${tableId}&elementId=${systable.id }'  />">
																								<button class="btn mb-2 btn-danger" type="button"
																									id="addIndex">&nbsp &nbsp حذف &nbsp
																									&nbsp</button>
																							</a>
													...
													<a
																href="<c:url value='/HomeConfiguration/details?id=${systable.id}&tableId=${tableId }' />">
																<i class="fe fe-eye"></i>
						...
						<div class="form-group col-md-12" align="left">
							...
							<a href="<c:url value='/HomeConfiguration/index' />">
			...
			<script>
				...
				function addIndexValue(tableId) {
					...
					window.location.href = "${pageContext.request.contextPath }/HomeConfiguration/create?tableId="
							+ tableId;
