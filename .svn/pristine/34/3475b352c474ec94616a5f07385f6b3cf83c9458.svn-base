...
<div style="direction: ltr;display: flex">
					...
					<button onclick="callDangerAlert('delete','تأكيد الحذف','متأكد من حذف العطلة الثابتة ',
												'/indHolidays/save/delete?id=${indHolidays.id}')" class="btn btn-primary-red" type="submit" style="margin-top: 5px" >&nbsp&nbsp&nbsp&nbsp حذف &nbsp&nbsp&nbsp&nbsp</button>
