			...
			<div class="card shadow">
				<div class="card-header">
					<div class="row mt-3" style="align-content: center;">
						<div class="col-md-10">
							<strong class="card-title"> حذف اعمولة </strong>
						</div>
					...
					<div class="row">
						...
						<div class="form-group col-md-12" align="left">
							...
							<button class="btn btn-danger" type="submit"
								id="deleteCommission"
								onclick="callDangerAlert('key','رسالة تأكيد','متأكد من عملية حذف العمولة { ${actionCommissionInfo.commission.nameA}}',
								'/commission/delete?id=${actionCommissionInfo.commission.id}')">&nbsp
		...
		<script>
			document
					.addEventListener(
							"DOMContentLoaded",
							function() {
								const precentageFlag = '${commission.precentageFlag}';
