		...
		<div class="col-12 ">
			...
			<div class="panel panel-default">
										...
										<div class="card-body">
											...
											<table class="table datatables" id="dataTable-1">
												<thead>
													<tr>
														<th>#</th>
														<th>رقم العملية في سجل التغيرات</th>
														<th> اسم  العملية</th>
															<th>الفرع </th>
														<th>المستخدم</th>
														<th>تاريخ العملية</th>
												...
												<tbody>
													<c:forEach varStatus="status" var="sysPage"
														...
														<tr id="row_${status.index}">
															<td>${sysPage.id}</td>
															<td>${sysPage.systemLogId.id}</td>
															<td 	>${sysPage.systemLogId.actionId.action_name_ar}</td>
																<td 	 >${sysPage.systemLogId.branchId.nameA}</td>
															...
															onclick="window.location.href='${pageContext.request.contextPath}/ModifyLog/details?id=${sysPage.id} '"
				...
				<jsp:include page="/WEB-INF/jsp/layout/pagination.jsp">
					<jsp:param name="controller_url" value="/ModifyLog/index" />
