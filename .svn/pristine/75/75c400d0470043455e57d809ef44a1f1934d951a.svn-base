...
<div class="container-fluid">
	...
	<div class="form-group col-md-6 row">
							<div class="form-group col-md-4 detail-label">الحد 
								الأدنى :</div>
							<div class="col-md-6"> ${currencySegment.currency.iso } ${currencySegment.fromSeg} </div>
						</div>

						<div class="form-group col-md-6 row">
							<div class="form-group col-md-4 detail-label"> الحد
								الأعلى :</div>
							<div class="col-md-6"> ${currencySegment.currency.iso } ${currencySegment.toSeg }</div>
						</div>
...
<div style="direction: ltr;display: flex">
					...
					<button onclick="callDangerAlert('delete','تأكيد الحذف','متأكد من حذف  الشريحة ',
												'/currencySegments/save/delete?id=${currencySegment.id}')" class="btn btn-primary-red" type="submit" style="margin-top: 5px" >&nbsp&nbsp&nbsp&nbsp حذف &nbsp&nbsp&nbsp&nbsp</button>
