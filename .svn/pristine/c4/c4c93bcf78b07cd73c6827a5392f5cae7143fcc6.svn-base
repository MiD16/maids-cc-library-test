...
<div class="container-fluid">
		...
		<div class="col-12 ">
			...
			<div class="card my-4">
				<div class="card-header">
					<strong> تفاصل الفائدة -<span style="color: #d1a923">
							${interest.accInterestCode }</span>
					</strong>
				</div>
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="form-group col-md-6 row">
							<div class="form-group col-md-4 detail-label">رمز الفائدة :</div>
							<div class="col-md-6">${interest.accInterestCode }</div>
						</div>
						<div class="form-group col-md-6 row">
							<div class="form-group col-md-4 detail-label">نوع الفائدة
								&nbsp :</div>
							<div class="col-md-6">${interest.accInterestTypeId.nameA }</div>
						</div>
	...
	<div class="form-group col-md-6 row">
							<div class="form-group col-md-4 detail-label">الوصف باللغة
								الأساسية :</div>
							<div class="col-md-6">${interest.descriptionA }</div>
						</div>

						<div class="form-group col-md-6 row">
							<div class="form-group col-md-4 detail-label">الوصف باللغة
								الثانوية :</div>
							<div class="col-md-6">${interest.descriptionB }</div>
						</div>
						...
						<div class="form-group col-md-6 row">
							...
							<div class="col-md-6">
								<c:if test="${interest.note!=''}">
							${interest.note }
							
							
							</c:if>
								<c:if test="${interest.note==null}">
							--
...
<div style="direction: ltr;display: flex">
					...
					<button onclick="callDangerAlert('delete','تأكيد الحذف','متأكد من حذف  الفائدة ',
												'/interest/save/delete?id=${interest.id}')" class="btn btn-primary-red" type="submit" style="margin-top: 5px" >&nbsp&nbsp&nbsp&nbsp حذف &nbsp&nbsp&nbsp&nbsp</button>
