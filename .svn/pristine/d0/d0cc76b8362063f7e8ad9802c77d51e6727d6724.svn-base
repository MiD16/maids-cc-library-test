			...
			<nav aria-alabel="breadcrumb " class="second ">
				...
				<ol class="breadcrumb indigo lighten-6 first  px-md-4"
					...
					<li class="breadcrumb-item font-weight-bold"><a
						class="black-text inactive text-uppercase  " href="<c:url value='/holidays/index' />"><span
							class="mr-md-3 mr-2">إدارة العطل</span></a><i
						class="fe fe-angle-double-right " aria-hidden="true"></i></li>
					<li class="breadcrumb-item font-weight-bold"><a
						class="black-text inactive text-uppercase " href="<c:url value='/holidays/index' />"><span>إستعراض
								 ايام العطل </span></a></li>
								 
								 <li class="breadcrumb-item font-weight-bold"><a
						class="black-text active text-uppercase " href="#"><span>
								 حذف العطلة  </span></a></li>
				</ol>
			</nav>
		...
		<div class="col-12 ">
			...
			<div class="card my-4">
				<div class="card-header">
					<strong>  حذف العطلة -<span style="color: #d1a923">
							${holidays.nameA }</span>
					</strong>
				</div>
				<div class="card-body">
...
<div style="direction: ltr;display: flex">
					...
					<button onclick="callDangerAlert('delete','تأكيد الحذف','متأكد من حذف يوم  العطلة  ',
												'/holidays/save/delete?id=${holidays.id}')" class="btn btn-primary-red" type="submit" style="margin-top: 5px" >&nbsp&nbsp&nbsp&nbsp حذف &nbsp&nbsp&nbsp&nbsp</button>
