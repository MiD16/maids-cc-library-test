...
<div class="message-box">
	<h1>404</h1>
	<p>page not found.</p><br><%= exception %> 
	<div class="buttons-con">
		<div class="action-link-wrap">
			<a onclick="history.back(-1)" class="link-button link-back-button">Go
				Back</a> <a href="${pageContext.request.contextPath}/" class="link-button">Go to Home Page</a>
		</div>
	</div>
</div></html>