...
<div class="container-fluid">
	...
	<div class="form-group col-md-6 row">
					...
					<button onclick="callDangerAlert('delete','تأكيد الحذف','متأكد من حذف  الفترة ',
												'/periods/save/delete?id=${period.id}')" class="btn btn-primary-red" type="submit" style="margin-top: 5px" >&nbsp&nbsp&nbsp&nbsp حذف &nbsp&nbsp&nbsp&nbsp</button>
