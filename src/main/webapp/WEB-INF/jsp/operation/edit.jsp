		...
		<div class="col-auto col-md-10  ">
			<nav aria-label="breadcrumb " class="second ">
				<ol class="breadcrumb indigo lighten-6 first  px-md-4"
					...
					<li class="breadcrumb-item font-weight-bold"><a
						class="black-text active text-uppercase " href="#"><span>تعديل  العملية
								 </span></a></li>
				</ol>
			</nav>
		</div>
	...
	<div class="row justify-content-center">
		<div class="col-12 ">
			...
			<div class="row mt-3">
				...
				<strong class="card-title"> تعديل العملية  -   <span style="color: #d1a923">
			...
			<form:form method="post" 
					name="formCreate"
						action="${pageContext.request.contextPath}/operation/edit"
					...
					<div class="card-body">
						...
						<div class="col-md-6">
											<div class="form-group">
												...
												<input  id="action_name_ar" name="action_name_ar"
											...
											<div class="form-group">
												...
												<input  id="action_name_en" name="action_name_en"
								...
								<div class="form-group">
									...
									<label for="indCatigoryModule">الوحدة التي تنتمي لها العملية *</label> <select
										...
										<optgroup label="الوحدة التي تنتمي لها الصلاحية ">
											...
											<c:forEach var="ind" items="${indCatigoryModules}">
												...
												<c:if test="${action.indCatigoryModule.id!=ind.id}">
													...
													<div class="col-md-6">
								<div class="form-group">
									<label for="indCreditDebitCatigory">   نوع العملية  *</label> <select
							...
							<div class="form-group col-md-6" id="subpoenaReqFlagDiv">
								...
								<c:if test="${action.subpoenaReqFlag==0 ||action.subpoenaReqFlag==null}">
									...
									<div class=" custom-radio form-check-inline">
										<input value="1" type="radio" id="subpoenaReqFlag2"
											name="subpoenaReqFlag" class="custom-control-input"> <label
											class="custom-control-label" for="subpoenaReqFlag2"> لا
										</label>
									</div>
								...
								<c:if test="${action.subpoenaReqFlag==1 }">
									<div class=" custom-radio form-check-inline">
										<input value="0" type="radio" id="subpoenaReqFlag"
											name="subpoenaReqFlag" class="custom-control-input"> <label
											class="custom-control-label" for="subpoenaReqFlag">نعم </label>
									</div>
								...
								<c:if test="${action.isTransactionFlag==0 ||action.isTransactionFlag==null}">
									...
									<div class=" custom-radio form-check-inline">
										<input value="1" type="radio" id="isTransactionFlag2"
											name="isTransactionFlag" class="custom-control-input"> <label
											class="custom-control-label" for="isTransactionFlag2"> لا
										</label>
									</div>
								...
								<c:if test="${action.isTransactionFlag==1 }">
									<div class=" custom-radio form-check-inline">
										<input value="0" type="radio" id="isTransactionFlag"
											name="isTransactionFlag" class="custom-control-input"> <label
											class="custom-control-label" for="isTransactionFlag">نعم </label>
									</div>
								...
								<div class="form-group ">
									...
									<label for="periodList">   فترة استحقاق العملية   *</label> <select
								...
								<c:if test="${action.afterflag==0 ||action.afterflag==null}">
									...
									<div class=" custom-radio form-check-inline">
										<input value="1" type="radio" id="afterflag2"
											name="afterflag" class="custom-control-input"> <label
											class="custom-control-label" for="afterflag2"> بعد تاريخ العملية
										</label>
									</div>
								...
								<c:if test="${action.afterflag==1 }">
									<div class=" custom-radio form-check-inline">
										<input value="0" type="radio" id="afterflag"
											name="afterflag" class="custom-control-input"> <label
											class="custom-control-label" for="afterflag">قبل تاريخ العملية  </label>
									</div>
						...
						<button class="btn btn-primary" type="submit" style="margin-top: 5px">تعديل</button>
					</div>
					</form:form>
