		...
		<div class="col-auto col-md-10  ">
			<nav aria-label="breadcrumb " class="second ">
				<ol class="breadcrumb indigo lighten-6 first  px-md-4"
					...
					<li class="breadcrumb-item font-weight-bold"><a
						class="black-text active text-uppercase " href="#"><span>استعراض الصلاحيات 
								</span></a></li>
				</ol>
			</nav>
		</div>
			...
			<div class="card shadow">
				...
				<div class="card-body">
										...
										<table class="table datatables" id="dataTable-1">
											<thead>
												<tr>
													...
													<th>اسم الصلاحية   </th>
													<th>اسم الصلاحية باللغة الثانوية  </th>
											...
											<tbody>					<c:forEach varStatus="status" var="varactionList"
													...
													<tr id="row_${status.index}">
														...
														<td >
															...
															onclick="window.location.href='${pageContext.request.contextPath}/action/edit?id=${varactionList.ID} '"
															class=" fe fe-edit icon-edit"></i>	
													
														<i 
															data-id="${status.index}"
															onclick="window.location.href='${pageContext.request.contextPath}/action/details?id=${varactionList.ID} '"
				 ...
				 <jsp:include page="/WEB-INF/jsp/layout/pagination.jsp">  
		 		 <jsp:param name="controller_url" value="/action/index" />
