		...
		<div class="col-auto col-md-10  ">
			<nav aria-label="breadcrumb " class="second ">
				<ol class="breadcrumb indigo lighten-6 first  px-md-4"
					...
					<li class="breadcrumb-item font-weight-bold"><a
						class="black-text active text-uppercase " href="#"><span>استعراض معلومات مستخدم
								 </span></a></li>
				</ol>
			</nav>
		</div>
		...
		<div class="col-12 ">
			...
			<div class="row mt-3">
				...
				<div class="card-header">
					...
					<strong class="card-title"> استعراض معلومات   ${user.fullname}  </strong>
						...
						<div class="wizard clearfix row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<label for="username"> اسم المستخدم *</label> <input readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<label for="first_name_a"> الاسم الأول *</label> <input readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input id="first_name_b" name="first_name_b" type="text" readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<label for="father_name_a"> اسم الأب *</label> <input readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<label for="father_name_b"> اسم الأب باللغة الثانوية </label> <input readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<label for="last_name_a"> الاسم الأخير *</label> <input readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									</label> <input id="last_name_b" name="last_name_b" type="text" readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<label for="mobile"> رقم الموبايل *</label> <input id="mobile" 
										name="mobile" type="number" class="form-control " readonly
										value="${user.mobile}">
									<div class="invalid-feedback">هذا الحقل مطلوب</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<label for="email"> البريد الإلكتروني </label> <input readonly
							...
							<div class="form-group col-md-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" class="form-control drgpicker" readonly
							...
							<div class="form-group col-md-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" required class="form-control drgpicker" readonly
							...
							<div class="form-group col-md-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="time" required class="form-control" readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<label for="teller_account_Id">رقم حساب الصندوق </label> <input readonly
								...
								<div class="form-group">
									...
									<label for="ip_terminal">رقم التعريف للحاسوب: </label> <input readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="limit_cash">سقف التعامل مع النقود *</label> <input readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="limit_non_cash">سقف التعامل مع الحسابات
										المصرفية *</label> <input id="limit_non_cash" name="limit_non_cash" readonly
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="account_debit_limit">سقف كشف الحساب *</label> <input readonly
								...
								<c:if
													test="${user.account_access_flag==1}">
							

								<div class=" custom-radio form-check-inline">
									<input value="1" type="radio"
										id="account_access_flag2"
										name="account_access_flag"
										class="custom-control-input" checked> <label
										class="custom-control-label"
								...
								<p class="mb-2">
								   في إجازة </p>
								   								...
								   								<c:if
													test="${user.vacation_flag==0 ||user.vacation_flag==null}">
								<div class=" custom-radio form-check-inline">
									<input value="0" type="radio" id="vacation_flag"
										name="vacation_flag"
										class="custom-control-input" checked> <label
										class="custom-control-label"
										for="vacation_flag">نعم </label>
								</div>
								...
								<c:if
													test="${user.specific_device_flag==1 }">
								

								<div class=" custom-radio form-check-inline">
									<input value="1" type="radio"
										id="specific_device_flag2"
										name="specific_device_flag"
										class="custom-control-input" checked> <label
										class="custom-control-label"
								...
								<p class="mb-2">
								    متاح </p>
								   <c:if
													test="${user.quit_flag==0 ||user.quit_flag==null}">
								<div class=" custom-radio form-check-inline">
									<input value="0" type="radio" id="quit_flag"
										name="quit_flag"
										class="custom-control-input" checked> <label
										class="custom-control-label"
										for="quit_flag">نعم </label>
								</div>

							
</c:if>
								   <c:if
													test="${user.quit_flag==1}">
